...
import { createBooking, getBookings, getBookingById, updateBookingStatus, Booking } from '@/services/firestore.service';
...
export const useCreateBooking = () => {
    ...
    return useMutation({
        mutationFn: (bookingData: Omit<Booking, 'id' | 'createdAt' | 'status'>) => createBooking(bookingData),
        onSuccess: () => {
