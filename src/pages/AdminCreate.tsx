...
import { signUpWithEmail, getAuthErrorMessage } from '@/services/auth.service';
import { createAdminProfile } from '@/services/firestore.service';
import {
  InputOTP,
  InputOTPGroup,
  InputOTPSlot,
...
const AdminCreate = () => {
  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create Firebase auth account - skip email verification as we're doing on-screen OTP
