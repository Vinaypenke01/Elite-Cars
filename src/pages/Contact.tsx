...
import { getDealershipSettings } from '@/services/firestore.service';
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Mon - Sat: {contactInfo.businessHours.mon_sat}</p>
                    <p className="text-muted-foreground">Sunday: {contactInfo.businessHours.sunday}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
